...
export default function NewPostPage() {
  ...
  const inputStyle = {
    ...
    outline:"none",color:"#1f2937",boxSizing:"border-box" as const,
    background:"white"
  }
    ...
    <div style={{maxWidth:800,margin:"0 auto"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"1rem"}}>
        ...
        <div style={{background:"white",borderRadius:14,padding:"1.25rem",boxShadow:"0 2px 8px rgba(0,0,0,0.06)",border:"1px solid #f3f4f6"}}>
          <h2 style={{color:"#1a2f6e",fontSize:"0.9rem",fontWeight:800,textTransform:"uppercase",letterSpacing:"0.04em",marginBottom:"1rem",margin:"0 0 1rem 0"}}>Content</h2>
        ...
        <div style={{background:"white",borderRadius:14,padding:"1.25rem",boxShadow:"0 2px 8px rgba(0,0,0,0.06)",border:"1px solid #f3f4f6"}}>
          ...
          <div style={{display:"flex",gap:"1.5rem",marginBottom:"0"}}>
